...
#define MinPotChange    5       // Controls how sensitive the Pot is to change
...
void setup_radio(void){
  ...
  if (true) { //(digitalRead(Switch_Pin1)== 0 ) { // Chan Hi Switch on
    RadioChanNo = 2;
  }
  else {
    RadioChanNo = 0;
  ...
  if (false) //(digitalRead(Switch_Pin0)== 0 ) // Chan Lo Switch on
